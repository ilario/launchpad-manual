...
In Launchpad you make translating your project possible by :ref:`importing a
PO template <how-to-import-project-translation-templates>` file. After the import, all the English strings from the
